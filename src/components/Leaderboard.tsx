                ...
                return (
                  <tr key={std.id} className={rowHighlight}>
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-3">
                        <a href={`/dev/${std.github_username}`} className="hover:opacity-85 transition-opacity" title="Ver perfil en Repo Rivals">
                          {std.avatar_url ? (
                            <img
                              src={std.avatar_url}
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <a href={`/dev/${std.github_username}`} className="text-sm font-bold text-white hover:text-emerald-400 transition-colors">
                              {std.nombre}
                            </a>
